...
parser.add_argument('--data_path', type=str, default=None,  help='Origin image path')
...
parser.add_argument('--lr_warmup', type=str2bool, default=False, help='Learning Rate warmup scheduler')
...
parser.add_argument("--lossfn", type=str, default='dicece', help="[ce,dicece,boundaryce,cldicece]")
parser.add_argument("--net", type=str, default=None, help="Networks, see models.py")
parser.add_argument("--net_inputch", type=int, default=3, help='dimension of input channel')
...
parser.add_argument("--net_norm", type=str, default='group', help='batch,instance,group,ws')
parser.add_argument("--net_nnblock", type=str2bool, default=False, help='True,False')
parser.add_argument("--half_precision", type=str2bool, default=False, help='True,False')
